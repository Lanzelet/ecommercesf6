...
class __TwigTemplate_1caa44b24ddfc3b489064e95b9c94f08 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Administrateur des utilisateurs ";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Administrateur des utilisateurs.</h1>
";
...
{% block title %}Administrateur des utilisateurs {% endblock %}

{% block body %}
    <h1>Administrateur des utilisateurs.</h1>
{% endblock %}", "admin/users/index.html.twig", "/var/www/html/ecommercesf6/templates/admin/users/index.html.twig");
    }
}
