...
<section class=\"container my-3\">
    <div class=\"row\">
        ...
        echo "\" class=\"btn btn-lg btn-secondary mt-3\">M'inscrire</a>
            </form>
        </div>
    </div>
</section>
    ...
    <div class=\"row\">
        <div class=\"col\">
            <form method=\"post\">
                ...
                {% if app.user %}
                    <div class=\"mb-3\">
                        Vous êtes déjà connecté(e) en tant que {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Se déconnecter</a>
                    </div>
                {% endif %}
                ...
                <a href=\"{{ path('app_register') }}\" class=\"btn btn-lg btn-secondary mt-3\">M'inscrire</a>
            </form>
        </div>
    </div>
</section>
{% endblock %}", "security/login.html.twig", "/var/www/html/ecommercesf6/templates/security/login.html.twig");
    }
}
