...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\CategoriesFixtures($b), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ImagesFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ProductsFixtures($b), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\UsersFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService')), $b), 'groups' => []]]);
